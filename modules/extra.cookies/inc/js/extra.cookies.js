...
(function ($) {
	...
	$.fn.extraCookies = function (options) {
		...
		$(this).each(function () {
			...
			if (opt.position === 'top') {
				$this.addClass('extra-cookies-popup-top extra-cookies-popup-positioned');
			} else if (opt.position === 'bottom') {
				$this.addClass('extra-cookies-popup-bottom extra-cookies-popup-positioned');
			}
			...
			function acceptCookies() {
				Cookies.set(opt.cookieName, opt.cookieValue, { expires: opt.expirationDays });
				hide();
			}
