...
function extra_slider_init() {
	...
	// DRAGGABLE
	wp_enqueue_script( 'draggable', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.0/utils/Draggable.min.js', array( 'jquery', 'tweenmax' ), EXTRA_VERSION, true );
	// EXTRA SLIDER
	wp_enqueue_script( 'extra.slider', EXTRA_MODULES_URI . '/extra.slider/inc/js/extra.slider.js', array( 'jquery', 'tweenmax', 'draggable' ), EXTRA_VERSION, true );
