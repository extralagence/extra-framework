 ...
 */
require_once EXTRA_INCLUDES_PATH . '/TGM-Plugin-Activation/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'extra_register_required_plugins' );
 ...
 */
function extra_register_required_plugins() {
	/*
