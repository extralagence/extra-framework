...
//		wp_enqueue_style('jquery-style', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.2/themes/smoothness/jquery-ui.css');
		wp_enqueue_style( 'extra-date.jquery-ui.theme', EXTRA_INCLUDES_URI . '/extra-metabox/css/jquery-ui-date/jquery-ui.theme.css' );
		wp_enqueue_style( 'extra-date.jquery-ui.structure', EXTRA_INCLUDES_URI . '/extra-metabox/css/jquery-ui-date/jquery-ui.structure.css' );
		wp_enqueue_style( 'extra-date.jquery-ui.css', EXTRA_INCLUDES_URI . '/extra-metabox/css/jquery-ui-date/jquery-ui.css' );
		...
		wp_enqueue_script( 'jquery-ui-timepicker-fr', EXTRA_INCLUDES_URI . '/extra-metabox/js/jquery-ui-timepicker-fr.js', array(
			'jquery-ui-datepicker',
			'jquery-ui-timepicker-addon'
		), null, true );

		wp_enqueue_script( 'extra-date-metabox', EXTRA_INCLUDES_URI . '/extra-metabox/js/extra-date.js', array(
			'jquery-ui-datepicker',
			'jquery-ui-timepicker-addon',
			'jquery-ui-timepicker-fr'
		), null, true );
	}

	public function the_admin() {
		?>
		<div class="<?php echo $this->css_class; ?> extra-jqueryui-datepicker-wrapper extra-date-wrapper extra-date-container <?php echo ( $this->required ) ? 'required' : '' ?>">
