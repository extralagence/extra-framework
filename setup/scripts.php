...
//	wp_enqueue_script('jquery', EXTRA_URI . '/assets/js/lib/fix_web_jquery.min.js', null, null, true);
	...
	// MOUSEWHEEL
	wp_enqueue_script('mousewheel', EXTRA_URI . '/assets/js/lib/jquery.mousewheel-3.0.6.pack.js', array('jquery'), null, true);
	// FANCYBOX
	wp_enqueue_script('fancybox', EXTRA_URI . '/assets/js/lib/jquery.fancybox.pack.js', array('jquery'), null, true);
	// FANCY SELECT
